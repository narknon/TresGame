...
void UScaleformUI_Factory::SetReimportPaths(UObject* Obj, const TArray<FString>& NewReimportPaths)
{
	USwfMovie* ImportedAsset = Cast<USwfMovie>(Obj);
...
EReimportResult::Type UScaleformUI_Factory::Reimport(UObject* Obj)
{
	USwfMovie* ImportedAsset = Cast<USwfMovie>(Obj);
